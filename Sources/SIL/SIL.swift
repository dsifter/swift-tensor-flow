...
// https://github.com/apple/swift/blob/main/docs/SIL/SIL.md
...
// https://github.com/apple/swift/blob/main/docs/SIL/SIL.md#functions
...
// https://github.com/apple/swift/blob/main/docs/SIL/SIL.md#basic-blocks
...
// https://github.com/apple/swift/blob/main/docs/SIL/SIL.md#instruction-set
// https://github.com/apple/swift/blob/main/include/swift/SIL/SILInstruction.h
public enum Operator: Equatable {
    // https://github.com/apple/swift/blob/main/docs/SIL/SIL.md#alloc-stack
    // alloc_stack $Float
    ...
    // https://github.com/apple/swift/blob/main/docs/SIL/SIL.md#apply
    ...
    // https://github.com/apple/swift/blob/main/docs/SIL/SIL.md#begin-access
    ...
    // https://github.com/apple/swift/blob/main/docs/SIL/SIL.md#begin-apply
    ...
    // https://github.com/apple/swift/blob/main/docs/SIL/SIL.md#builtin
    ...
    // https://github.com/apple/swift/blob/main/docs/SIL/SIL.md#cond-fail
    // cond_fail %9 : $Builtin.Int1, "arithmetic overflow"
    case condFail(_ operand: Operand, _ message: String)

    // https://github.com/apple/swift/blob/main/docs/SIL/SIL.md#convert-escape-to-noescape
    ...
    // https://github.com/apple/swift/blob/main/docs/SIL/SIL.md#convert-function
    ...
    // https://github.com/apple/swift/blob/main/docs/SIL/SIL.md#copy-addr
    ...
    // https://github.com/apple/swift/blob/main/docs/SIL/SIL.md#dealloc-stack
    // dealloc_stack %162 : $*IndexingIterator<Range<Int>>
    case deallocStack(_ operand: Operand)

    // https://github.com/apple/swift/blob/main/docs/SIL/SIL.md#debug-value
    ...
    // https://github.com/apple/swift/blob/main/docs/SIL/SIL.md#debug-value-addr
    ...
    // https://github.com/apple/swift/blob/main/docs/SIL/SIL.md#destructure-tuple
    // destructure_tuple %2 : $(Array<Int>, Builtin.RawPointer)
    case destructureTuple(_ operand: Operand)

    // https://github.com/apple/swift/blob/main/docs/SIL/SIL.md#end-access
    // end_access %265 : $*Array<Float>
    // end_access [abort] %42 : $T
    case endAccess(_ abort: Bool, _ operand: Operand)

    // https://github.com/apple/swift/blob/main/docs/SIL/SIL.md#end-apply
    // end_apply %268
    ...
    // https://github.com/apple/swift/blob/main/docs/SIL/SIL.md#enum
    ...
    // https://github.com/apple/swift/blob/main/docs/SIL/SIL.md#pointer-to-address
    // pointer_to_address %4 : $Builtin.RawPointer to [strict] $*Int
    case pointerToAddress(_ operand: Operand, _ strict: Bool, _ type: Type)

    // https://github.com/apple/swift/blob/main/docs/SIL/SIL.md#release-value
    // release_value %21 : $TensorShape
    case releaseValue(_ operand: Operand)

    // https://github.com/apple/swift/blob/main/docs/SIL/SIL.md#retain-value
    // retain_value %124 : $TensorShape
    case retainValue(_ operand: Operand)

    // https://github.com/apple/swift/blob/main/docs/SIL/SIL.md#select-enum
    ...
    // https://github.com/apple/swift/blob/main/docs/SIL/SIL.md#tuple
    // tuple (%a : $A, %b : $B, ...)
    // tuple $(a:A, b:B, ...) (%a, %b, ...)
    case tuple(_ elements: TupleElements)

    // https://github.com/apple/swift/blob/main/docs/SIL/SIL.md#tuple-extract
    ...
    // https://github.com/apple/swift/blob/main/docs/SIL/SIL.md#witness-method
...
// https://github.com/apple/swift/blob/main/docs/SIL/SIL.md#terminators
public enum Terminator: Equatable {
    // https://github.com/apple/swift/blob/main/docs/SIL/SIL.md#br
    // br bb9
    // br label (%0 : $A, %1 : $B)
    case br(_ label: String, _ operands: [Operand])

    // https://github.com/apple/swift/blob/main/docs/SIL/SIL.md#cond-br
    // cond_br %11, bb3, bb2
    ...
    // https://github.com/apple/swift/blob/main/docs/SIL/SIL.md#return
    // return %11 : $Int
    case `return`(_ operand: Operand)

    // https://github.com/apple/swift/blob/main/docs/SIL/SIL.md#switch-enum
    ...
    // https://github.com/apple/swift/blob/main/docs/SIL/SIL.md#unreachable
    // unreachable
    case unreachable
}
...
// https://github.com/apple/swift/blob/main/docs/SIL/SIL.md#calling-convention
...
// https://github.com/apple/swift/blob/main/docs/SIL/SIL.md#declaration-references
...
// https://github.com/apple/swift/blob/main/docs/SIL/SIL.md#linkage
...
// https://github.com/apple/swift/blob/main/docs/SIL/SIL.md#debug-information
...
// https://github.com/apple/swift/blob/main/docs/SIL/SIL.md#values-and-operands
...
// https://github.com/apple/swift/blob/main/docs/SIL/SIL.md#properties-of-types
